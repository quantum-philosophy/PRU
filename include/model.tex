...
called cells and shown as a group of blue boxes in \fref{model}. The network can
be made as many layers deep as needed. Each cell is composed of a number of
units, which are depicted by double circles in \fref{model}. We let $c$ and $u$
...
prevent potential overfitting \cite{hastie2009}. We let $p$ be the probability
of dropping an output of a cell.
