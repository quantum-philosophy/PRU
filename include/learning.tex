...
which are to be optimized during training (see \sref{training}), hyperparameters
are to be set prior to training and kept unchanged thereafter. The impact of
...
was biased (we deliberately chose the one that had the best performance on
$X_2$).
...
At this point, the main aspects of our workflow depicted in \fref{workflow} have
