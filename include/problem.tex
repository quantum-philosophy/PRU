...
Let us now adumbrate our solution workflow, which is illustrated in
\fref{workflow}. Given raw resource-usage traces, we first (pre)process them in
order to make these data suitable for the subsequent computations. This part is
explained in the next section and can be seen on the left of \fref{workflow}.
